...
* @function ImageItem
**/
class ImageVerticalItem extends Component {
    ...
    render(){
        return (
            <View style={styles.imageBox}>
                <Image style={styles.imageHomeVertical} source={{ uri: this.props.imageUrl }} />
...
export default ImageVerticalItem